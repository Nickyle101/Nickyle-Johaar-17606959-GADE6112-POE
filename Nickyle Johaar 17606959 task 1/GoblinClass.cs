...
namespace Nickyle_Johaar_17606959_task_1
{
    ...
    class GoblinClass : enemiesClass
    {
        ...
        public override string ToString()
        {
            ...
            if (weaponItem == null)
            {
                displayoutput = "Barehand goblin position at [" + PositionX + "," + PositionY+ "] Damage Dealt:(" + PlayerDamage + ") HealthPoints:" + PlayerHP + "possess" + GoldPickUp + "gold";
            }
            else
            {
                displayoutput= "Goblin by position [" + PositionX + "," + PositionY + "] Damage dealt by Goblin:(" + PlayerDamage + ") Player HP:" + PlayerHP;
            }
        ...
        {
            base.goldPickUp = 1;
            base.weaponItem = new meleeweaponClass(TypeOfWeaponUsed.Dagger, "DG");
        }
    }
